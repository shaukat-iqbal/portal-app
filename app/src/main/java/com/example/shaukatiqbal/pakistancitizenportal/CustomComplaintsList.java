...
public class CustomComplaintsList extends ArrayAdapter<complain> {
    Activity context;
    int[] colorCodes= {0xffff99,0x6666ff,0x4ddbff,0x2babff};
    ArrayList<complain> complaintsList;
    ArrayList<Bitmap> qrCodes;
    public CustomComplaintsList(Activity context, ArrayList<complain> complaintsList, ArrayList<Bitmap> qrCodesArray) {
        super(context, R.layout.complain_row,complaintsList);
